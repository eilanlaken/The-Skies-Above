...
public class TestSceneUI2 extends Scene {
    ...
    public TestSceneUI2(ApplicationContext context) {
        super(context);
    }

    @Override
    public void show () {
        skin = new Skin(Gdx.files.internal("ui/uiskin2.json"));
        texture1 = new Texture(Gdx.files.internal("ui/realmadrid.png"));
        texture2 = new Texture(Gdx.files.internal("ui/eye.jpg"));
