    ...
    protected void start() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            entityMini.body = createBody(world, new RigidBody2DData(
                    ...
                    UtilsRigidBody2D.getBox2DLength(entityMini.animation.getKeyFrame(0).getRegionWidth(), 64),
                    UtilsRigidBody2D.getBox2DLength(entityMini.animation.getKeyFrame(0).getRegionHeight(), 64),
                    filter,
                    1,1,0.2f,false),
        ...
        */
        ...
        mouse.body = createBody(world, new RigidBody2DData(
                        ...
                        RigidBody2DData.Shape.RECTANGLE,
                        UtilsRigidBody2D.getBox2DLength(mouse.animation.getKeyFrame(0).getRegionWidth(), 64),
                        UtilsRigidBody2D.getBox2DLength(mouse.animation.getKeyFrame(0).getRegionHeight(), 64),
                        new Filter(),
                        1,1,0.2f,false),
                        mouse.transform2D
        );
