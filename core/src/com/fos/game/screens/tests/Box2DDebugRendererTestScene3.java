...
public class Box2DDebugRendererTestScene3 extends Scene {
    ...
    public Box2DDebugRendererTestScene3(final GameContext context) {
        super(context);
    }
    ...
    protected void start() {
        ...
        entities = new Array<>();
        camera = context.factoryCamera2D.createCamera2D(20, 20 * Gdx.graphics.getHeight() / Gdx.graphics.getWidth());
