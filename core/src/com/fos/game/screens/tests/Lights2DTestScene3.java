...
public class Lights2DTestScene3 extends Scene {
    ...
    protected void start() {
        ...
        rayHandler1 = new RayHandler(world);
        rayHandler1.setAmbientLight(0.2f);
        rayHandler2 = new RayHandler(world);
        rayHandler2.setAmbientLight(1f);
        pointLight1 = new PointLight(rayHandler1, 100, Color.BLUE, 5, 0,0);
        pointLight2 = new PointLight(rayHandler2, 100, Color.RED, 5, 2,2);
    ...
    protected void update(float delta) {
        ...
        camera.lens.update();
        rayHandler1.setCombinedMatrix(camera.lens);
        rayHandler2.setCombinedMatrix(camera.lens);
