...
public class PostProcessingSinglePassGaussianBlurHDShaderProgram extends ShaderProgram {

    private static final String vertex = Gdx.files.classpath("shaders/post/fosSinglePassBlurHDVertexShader.glsl").readString();
    private static final String fragment = Gdx.files.classpath("shaders/post/fosSinglePassBlurHDFragmentShader.glsl").readString();
    ...
    public PostProcessingSinglePassGaussianBlurHDShaderProgram() {
