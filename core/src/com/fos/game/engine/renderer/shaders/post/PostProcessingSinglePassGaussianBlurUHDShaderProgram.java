package com.fos.game.engine.renderer.shaders.post;
...
public class PostProcessingSinglePassGaussianBlurUHDShaderProgram extends ShaderProgram {

    private static final String vertex = Gdx.files.classpath("shaders/post/fosSinglePassBlurUHDVertexShader.glsl").readString();
    private static final String fragment = Gdx.files.classpath("shaders/post/fosSinglePassBlurUHDFragmentShader.glsl").readString();
    ...
    public PostProcessingSinglePassGaussianBlurUHDShaderProgram() {
