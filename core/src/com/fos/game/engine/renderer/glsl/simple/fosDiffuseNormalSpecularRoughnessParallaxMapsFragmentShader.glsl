...
void main() {
    ...
    vec2 uv_specular = vec2((specular_map.x + offset_coords.x * width) * atlas_width_inv, (specular_map.y + offset_coords.y * height) * atlas_height_inv);
    vec2 uv_roughness = vec2((roughness_map.x + offset_coords.x * width) * atlas_width_inv, (roughness_map.y + offset_coords.y * height) * atlas_height_inv);
