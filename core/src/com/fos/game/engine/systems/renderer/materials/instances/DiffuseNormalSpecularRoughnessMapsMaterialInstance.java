...
import com.fos.game.engine.systems.renderer.materials.base.*;
...
public class DiffuseNormalSpecularRoughnessMapsMaterialInstance extends Material implements RenderedDiffuseMap, RenderedNormalMap, RenderedSpecularMap, RenderedRoughnessMap {
    ...
    public DiffuseNormalSpecularRoughnessMapsMaterialInstance(final TextureAtlas spriteSheet,
                                                              final float ambient,
    ...
    public ShadingMethod getShadingMethod() {
        return ShadingMethod.DiffuseNormalSpecularRoughnessMaps;
    }
