...
public class RiggedModelInstance extends ModelInstance {
    ...
    public RiggedModelInstance(final Model model, final HashMap<String, FOSMaterial> materialInstances, Matrix4 transform, final String riggedModelNodeId, final String rigHierarchyId) {
