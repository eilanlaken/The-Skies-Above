...
import com.fos.game.engine.ecs.systems.renderer_old.shaders.postprocessing.PostProcessingShaderProgram;
...
public class Renderer implements EntitiesProcessor, Disposable {
    ...
    public Renderer() {
        ...
        frameBufferBuilderScene.addColorTextureAttachment(GL30.GL_RGBA8, GL30.GL_RGBA, GL30.GL_UNSIGNED_BYTE); // <- black silhouette of rendered objects
