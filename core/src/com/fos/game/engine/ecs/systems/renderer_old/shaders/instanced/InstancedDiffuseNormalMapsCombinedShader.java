package com.fos.game.engine.ecs.systems.renderer_old.shaders.instanced;

public class InstancedDiffuseNormalMapsCombinedShader {
    /*
    ...
    public InstancedDiffuseNormalMapsCombinedShader() {
        init();
    }

    @Override
    public void init() {
        String vertex = Gdx.files.internal("shaders/instanced/fosInstancedDiffuseNormalMapsVertexShader.glsl").readString();
        String fragment = Gdx.files.internal("shaders/instanced/fosInstancedDiffuseNormalMapsFragmentShader.glsl").readString();
    ...
    private void loadEnvironmentsParamsToGPU(final RenderingEnvironment renderingEnvironment) {
        ...
        float gamma = FOSOptionsBox.DEFAULT_GAMMA;
