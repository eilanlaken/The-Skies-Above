...
import com.fos.game.engine.ecs.components.lights.ComponentSpotLight;
...
public class UniformColorShader extends GameShader {

    // current render context - for optimization: prevent unnecessary uniform bindings.
    private Camera camera;
    private RenderContext renderContext;
    private LightingEnvironment lightingEnvironment;
    private UniformColorMaterialInstance materialInstance;
    ...
    public UniformColorShader() {
        super(Gdx.files.internal("shaders/simple/fosUniformColorVertexShader.glsl").readString(),
                Gdx.files.internal("shaders/simple/fosUniformColorFragmentShader.glsl").readString());
    }
