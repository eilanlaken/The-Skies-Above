package com.fos.game.engine.ecs.systems.renderer_old.shaders.pbr;
...
import com.fos.game.engine.ecs.systems.renderer_old.materials.instances.AlbedoNormalMapsMaterialInstance;
import com.fos.game.engine.ecs.systems.renderer_old.shaders.base.GameShader;
import com.fos.game.engine.ecs.systems.renderer_old.base.Renderer;

public class PBRAlbedoNormalMapsShader extends GameShader {
    ...
    public PBRAlbedoNormalMapsShader() {
        super(Gdx.files.internal("shaders/pbr/pbrAlbedoNormalMapsVertexShader.glsl").readString(),
                Gdx.files.internal("shaders/pbr/pbrAlbedoNormalMapsFragmentShader.glsl").readString());
        shaderProgram.bind();
    ...
    public void render(Renderable renderable) {
        ...
        AlbedoNormalMapsMaterialInstance fosMaterial = (AlbedoNormalMapsMaterialInstance) modelInstance.getMaterial(renderable);
        loadMaterialParamsToGPU(fosMaterial);
        renderable.meshPart.render(shaderProgram);
    }

    private void loadMaterialParamsToGPU(final AlbedoNormalMapsMaterialInstance fosMaterial) {
        // bind texture
    ...
    protected void registerUniformLocations() {
        ...
        uniform_reflectivityLocation = shaderProgram.fetchUniformLocation("metallic", false);
        uniform_roughnessLocation = shaderProgram.fetchUniformLocation("roughness", false);
