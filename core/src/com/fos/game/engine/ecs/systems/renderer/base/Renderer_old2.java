...
public class Renderer_old2 implements EntitiesProcessor, Disposable {
    ...
    public void process(final Array<Entity> entities) {
        RenderingUtils_old.prepareForRendering(entities, lightingEnvironment, camera2DEntitiesMap, camera3DEntitiesMap, renderTargetCamerasMap);
    ...
    public boolean shouldProcess(Entity entity) {
        if ((entity.componentsBitMask & RenderingUtils_old.ATTACHED_ANIMATIONS_2D_BIT_MASK) > 0) return true;
