...
import com.fos.game.engine.ecs.systems.renderer_old.materials.instances.DiffuseNormalSpecularRoughnessParallaxMapsMaterialInstance;
...
public class DiffuseNormalSpecularRoughnessParallaxMapsShader extends GameShader {
    ...
    public DiffuseNormalSpecularRoughnessParallaxMapsShader() {
        super(Gdx.files.internal("shaders/simple/fosDiffuseNormalSpecularRoughnessParallaxMapsVertexShader.glsl").readString(),
                Gdx.files.internal("shaders/simple/fosDiffuseNormalSpecularRoughnessParallaxMapsFragmentShader.glsl").readString());
        shaderProgram.bind();
    ...
    public void render(Renderable renderable) {
        ...
        DiffuseNormalSpecularRoughnessParallaxMapsMaterialInstance fosMaterial = (DiffuseNormalSpecularRoughnessParallaxMapsMaterialInstance) modelInstance.getMaterial(renderable);
        loadMaterialParamsToGPU(fosMaterial);
        renderable.meshPart.render(shaderProgram);
    }

    private void loadMaterialParamsToGPU(final DiffuseNormalSpecularRoughnessParallaxMapsMaterialInstance fosMaterial) {
        // bind texture
