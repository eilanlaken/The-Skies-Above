...
import com.fos.game.engine.ecs.systems.renderer_old.materials.instances.DiffuseNormalBloomMapsMaterialInstance;
...
public class DiffuseNormalBloomMapsShader extends GameShader {
    ...
    public DiffuseNormalBloomMapsShader() {
        super(Gdx.files.internal("shaders/simple/fosDiffuseNormalBloomMapsVertexShader.glsl").readString(),
                Gdx.files.internal("shaders/simple/fosDiffuseNormalBloomMapsFragmentShader.glsl").readString());
        shaderProgram.bind();
    ...
    public void render(Renderable renderable) {
        ...
        DiffuseNormalBloomMapsMaterialInstance fosMaterial = (DiffuseNormalBloomMapsMaterialInstance) modelInstance.getMaterial(renderable);
        loadMaterialParamsToGPU(fosMaterial);
        renderable.meshPart.render(shaderProgram);
    }

    private void loadMaterialParamsToGPU(final DiffuseNormalBloomMapsMaterialInstance fosMaterial) {
        // bind texture
        ...
        final float xNormal = fosMaterial.xNormal;
        final float yNormal = fosMaterial.yNormal;
        final float xBloom = fosMaterial.xBloom;
        final float yBloom = fosMaterial.yBloom;
