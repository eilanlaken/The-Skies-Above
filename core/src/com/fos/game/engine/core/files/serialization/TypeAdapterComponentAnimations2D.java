...
public class TypeAdapterComponentAnimations2D implements JsonSerializer<ComponentFrameAnimations2D>, JsonDeserializer<ComponentFrameAnimations2D> {
    ...
    @Override
    public JsonElement serialize(ComponentFrameAnimations2D src, Type typeOfSrc, JsonSerializationContext context) {
    ...
    @Override
    public ComponentFrameAnimations2D deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
