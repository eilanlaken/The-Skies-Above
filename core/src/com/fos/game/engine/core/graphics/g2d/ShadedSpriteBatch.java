...
public class ShadedSpriteBatch {
    ...
    public ShadedSpriteBatch () {
        this(1000);
    }

    public ShadedSpriteBatch (int size) {
    ...
    /** Returns a new instance of the default defaultShader used by SpriteBatch for GL2 when no defaultShader is specified. */
    ...
    public void flush () {
        ...
        mesh.render(customShader != null ? customShader : defaultShader, GL20.GL_TRIANGLES, 0, count);
    ...
    private void bindUniformsToGPU() {
        if (customShader != null) {
            customShader.bindUniformsToGPU();
