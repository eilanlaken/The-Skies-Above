 ...
 * @author Nathan Sweet */
public class ExperimentalPolygonTextureBatch implements PolygonBatch {
    ...
    public ExperimentalPolygonTextureBatch() {
        this(2000, null);
    }

    public ExperimentalPolygonTextureBatch(int size) {
        this(size, size * 2, null);
    }

    public ExperimentalPolygonTextureBatch(int size, ShaderProgram defaultShader) {
    ...
    public ExperimentalPolygonTextureBatch(int maxVertices, int maxTriangles, ShaderProgram defaultShader) {
    ...
    public void begin(Camera camera, Shader customShader) {
